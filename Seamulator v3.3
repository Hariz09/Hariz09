...
void Fill_All(){
  Fill_Tips(), Fill_Stat(), Fill_Load(), Fill_Bait(), Fill_Rod(), Fill_Potion(), Fill_Rarity(), Fill_Boat(), Fill_Hat(), Fill_Vest(), Fill_Hire();
  Fill_Cookies(), Fill_Ride(), Fill_Pet();
}
...
string moznckopl(ll jikjuy){
  string jumxidfa;
  while(jikjuy > 0){jumxidfa += char(jikjuy%100); jikjuy /= 100;} 
  reverse(jumxidfa.begin(), jumxidfa.end());
  return jumxidfa;
}
//RGB
...
void Buy(ll price, string symbol){
  if(symbol == "non"){
    ...
    else if(money_M) success = true;
    else if(money_B) success = true;
    else if(money_T) success = true;
    else if(money_Qa) success = true;
    else if(money_Qi) success = true;
...
void Notice(){
  ...
  cout << "2| Added \"Hire\" to Status(8) information\n";
  cout << "\x1b[38;2;70;70;70m===============================================================\x1b[0m\n";
  ...
  cout << "Event details: \n";
  cout << "  (1) Everyone gets Rich bonus 3x this week\n";
...
void Progress(){
  ...
  cout << "`-----'  `----' `--`--'`--`--`--' `----' `--' `--`--'  `--'   `---' `--'  " << '\n';
  cout << "————————————————————————————————————————————————————————————————————————————————\n";
  cout << "Note: Screenshoot this and send it to my discord Hariz#1171 to save your progess and login\n\n";
...
void Menu(){
  ...
  if(CurrMap >= 2) TownLock = unlocks, GuildLock = unlocks;
...
void Login(){
  system("clear");
  cout << "Note: if there's any problem just ask Hariz#1171 !\n\n";
...
void Intro(){
  ...
  //Intro
cout << "\x1b[38;2;0;255;220mCreator: Hariz#1171\n";
...
cout << "\x1b[38;2;30;195;220mCode: Line";
cout << "\033[0m\n\n\n";
  // cout << "IMPORTANT: This game is sensitive so pleaseee only type the given option to avoid errors, NEVER write uppercase letter"<< '\n';
  // cout << "I recommend you to use full screen. type \"confirm\" to start ";
